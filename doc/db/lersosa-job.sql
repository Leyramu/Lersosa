DROP DATABASE IF EXISTS `lersosa-job`;

CREATE DATABASE  `lersosa-job` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
...
INSERT INTO `sj_group_config` VALUES (1, 'dev', 'lersosa_group', '', 'SJ_cKqBTPzCsWA3VyuCfFoccmuIEGXjr5KT', 1, 1, 0, 1, 1, 4, now(), now());
INSERT INTO `sj_group_config` VALUES (2, 'prod', 'lersosa_group', '', 'SJ_cKqBTPzCsWA3VyuCfFoccmuIEGXjr5KT', 1, 1, 0, 1, 1, 4, now(), now());
...
INSERT INTO `sj_job` VALUES (1, 'dev', 'lersosa_group', 'demo-job', null, 1, 1710344035622, 1, 1, 4, 1, 'testJobExecutor', 2, '60', 1, 60, 3, 1, 1, 116, 0, '', '', 0 , now(), now());
