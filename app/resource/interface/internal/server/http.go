...
import (
	v1File "lersosa/api/resource/interface/v1/file"
	v1OssConfig "lersosa/api/resource/interface/v1/ossconfig"
...
func NewHTTPServer(
	c *conf.Server,
	ossConfig *web.OssConfigController,
	file *web.FileController,
	logger log.Logger,
) *http.Server {
	...
	v1OssConfig.RegisterOssConfigHTTPServer(
		srv,
		ossConfig,
	)
	v1File.RegisterFileHTTPServer(
		srv,
		file,
	)

	router := srv.Route("/")
	router.POST("/resource/v1/file/upload", file.UploadMultipartFile)
