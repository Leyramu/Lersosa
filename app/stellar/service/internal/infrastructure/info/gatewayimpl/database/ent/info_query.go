...
func (_q *InfoQuery) FirstID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *InfoQuery) FirstIDX(ctx context.Context) uuid.UUID {
...
func (_q *InfoQuery) OnlyID(ctx context.Context) (id uuid.UUID, err error) {
	var ids []uuid.UUID
...
func (_q *InfoQuery) OnlyIDX(ctx context.Context) uuid.UUID {
...
func (_q *InfoQuery) IDs(ctx context.Context) (ids []uuid.UUID, err error) {
...
func (_q *InfoQuery) IDsX(ctx context.Context) []uuid.UUID {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *InfoQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(info.Table, info.Columns, sqlgraph.NewFieldSpec(info.FieldID, field.TypeUUID))
	_spec.From = _q.sql
