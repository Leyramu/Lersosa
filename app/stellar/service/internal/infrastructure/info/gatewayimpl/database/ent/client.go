...
func (c *InfoClient) UpdateOneID(id uuid.UUID) *InfoUpdateOne {
...
func (c *InfoClient) DeleteOneID(id uuid.UUID) *InfoDeleteOne {
...
func (c *InfoClient) Get(ctx context.Context, id uuid.UUID) (*Info, error) {
	return c.Query().Where(info.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *InfoClient) GetX(ctx context.Context, id uuid.UUID) *Info {
