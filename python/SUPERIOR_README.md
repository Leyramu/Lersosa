...
[![Version](https://img.shields.io/badge/Version-v3.2.0-success.svg)](https://https://github.com/Leyramu/Lersosa)
[![License](https://img.shields.io/badge/License-Apache-blue.svg)](https://https://github.com/Leyramu/Lersosa/blob/master/LICENSE)
...
3. Java 后端 Demo 运行使用 Java-23.0.2 测试通过
4. Vue 前端 Demo 运行使用 Vite-6.2.2 测试通过
...
介绍：微服务管理系统 重写RuoYi-Cloud所有功能 整合 SpringCloudAlibaba、Dubbo3.0、Sa-Token、Mybatis-Plus、MQ、Flowable、ES、Docker 全方位升级 定期同步。
