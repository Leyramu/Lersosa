...
class FetcherStrategyI(ABC):
    ...
    @staticmethod
    def get_strategy(strategy_name: str, config: Any = None) -> "FetcherStrategyI":
        """根据策略名称获取对应的策略实例
        ...
        all_strategies = bean_container.get_beans_by_type(FetcherStrategyI)
