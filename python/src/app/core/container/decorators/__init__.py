...
from .required_args_constructor import RequiredArgsConstructorDecorator
from .route_decorators import RouterMapping

# 导出路由装饰器别名
GetMapping = RouterMapping.GetMapping
PostMapping = RouterMapping.PostMapping
PutMapping = RouterMapping.PutMapping
DeleteMapping = RouterMapping.DeleteMapping
PatchMapping = RouterMapping.PatchMapping
WebSocketMapping = RouterMapping.WebSocketMapping
RequiredArgsConstructor = RequiredArgsConstructorDecorator.decorate

__all__ = [
    "RequiredArgsConstructorDecorator",
    "RouterMapping",
