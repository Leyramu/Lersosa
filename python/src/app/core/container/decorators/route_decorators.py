...
class RouterMapping:
    """路由装饰器工厂类，提供Spring风格的路由映射装饰器"""

    @staticmethod
    def GetMapping(path: str, **kwargs):
        """GET请求路由装饰器"""
        def decorator(func):
            func.__router_method__ = ('get', path, kwargs)
            return func
        return decorator
    ...
    def PostMapping(path: str, **kwargs):
        """POST请求路由装饰器"""
        def decorator(func):
            func.__router_method__ = ('post', path, kwargs)
            return func
        return decorator
    ...
    def PutMapping(path: str, **kwargs):
        """PUT请求路由装饰器"""
        def decorator(func):
            func.__router_method__ = ('put', path, kwargs)
            return func
        return decorator
    ...
    def DeleteMapping(path: str, **kwargs):
        """DELETE请求路由装饰器"""
        def decorator(func):
            func.__router_method__ = ('delete', path, kwargs)
            return func
        return decorator
    ...
    def PatchMapping(path: str, **kwargs):
        """PATCH请求路由装饰器"""
        def decorator(func):
            func.__router_method__ = ('patch', path, kwargs)
            return func
        return decorator

    @staticmethod
    def WebSocketMapping(path: str, **kwargs):
        """WebSocket路由装饰器"""
        def decorator(func):
            func.__router_method__ = ('websocket', path, kwargs)
            return func
        return decorator
