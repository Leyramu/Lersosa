...
class CrawlerConfig:
    ...
    OUTPUT_DIR: str = os.getenv("CRAWLER_OUTPUT_DIR", "src/algo/data/processed/train")
    SNAPSHOT_DIR: str = os.getenv("CRAWLER_SNAPSHOT_DIR", "src/algo/data/processed/snapshots")

    PLAYWRIGHT_BROWSERS_PATH: str = os.getenv(
        "PLAYWRIGHT_BROWSERS_PATH", 
        str(Path(__file__).parent.parent.parent.parent.parent / "ms-playwright")
    )
