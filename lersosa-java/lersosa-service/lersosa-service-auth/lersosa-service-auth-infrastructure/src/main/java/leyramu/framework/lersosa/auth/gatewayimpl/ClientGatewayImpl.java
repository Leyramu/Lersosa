...
import leyramu.framework.lersosa.auth.convert.ClientConvertor;
import leyramu.framework.lersosa.auth.gateway.ClientGateway;
...
public class ClientGatewayImpl implements ClientGateway {
     ...
     */
    @Override
    public ClientV queryByClientId(String clientId) {
        return ClientConvertor.toDomainObject(remoteClientService.queryByClientId(clientId));
    }
}
