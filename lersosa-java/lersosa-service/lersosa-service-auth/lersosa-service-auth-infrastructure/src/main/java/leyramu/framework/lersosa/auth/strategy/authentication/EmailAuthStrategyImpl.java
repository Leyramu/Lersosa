...
import leyramu.framework.lersosa.auth.model.form.EmailLoginBody;
 ...
 */
@Slf4j
@Service("email" + AuthStrategyI.BASE_NAME)
@RequiredArgsConstructor
public class EmailAuthStrategyImpl implements AuthStrategyI {
    ...
    public LoginCo login(String body, ClientV clientV) {
        ...
        LoginUser loginUser = TenantHelper.dynamic(tenantId, () -> {
            ...
            authDomainService.checkLogin(LoginType.EMAIL, tenantId, user.getUsername(), () -> !validateEmailCode(tenantId, email, emailCode));
            return user;
        });
    ...
    private boolean validateEmailCode(String tenantId, String email, String emailCode) {
        ...
        if (StringUtils.isBlank(code)) {
            authDomainService.recordLogininfor(tenantId, email, Constants.LOGIN_FAIL, MessageUtils.message("user.jcaptcha.expire"));
