...
public class SocialCallbackCmdExe {
     ...
     * @return 结果对象
     */
    public Result<Void> executeVoid(String body) {
        String result = authDomainService.socialCallback(new AuthA(body));
        return !"".equals(result) ? Result.fail(result) : Result.ok();
    }
}
