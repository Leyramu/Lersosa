...
import leyramu.framework.lersosa.auth.api.CaptchaServiceI;
import leyramu.framework.lersosa.auth.dto.co.CaptchaCo;
import leyramu.framework.lersosa.auth.command.query.CaptchaGetQryExe;
...
public class CaptchaServiceImpl implements CaptchaServiceI {
     ...
     */
    @Override
    public Result<CaptchaCo> getCode() {
        return captchaGetQryExe.execute();
    }
}
