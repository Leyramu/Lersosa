...
public class UnlockSocialCmdExe {
     ...
     * @return 结果对象
     */
    public Result<Void> executeVoid(Long socialId) {
        return authDomainService.unlockSocial(socialId) ? Result.ok() : Result.fail("取消授权失败");
    }
}
