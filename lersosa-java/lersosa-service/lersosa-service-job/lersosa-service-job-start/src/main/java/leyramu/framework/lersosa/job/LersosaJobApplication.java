...
package leyramu.framework.lersosa.job;
...
public class LersosaJobApplication {
    ...
    public static void main(String[] args) {
        CustomSpringApplication application = new CustomSpringApplication(LersosaJobApplication.class);
