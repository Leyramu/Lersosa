...
<template>
  <div class="app-container">
    ...
    <el-table ref="operlogRef" v-loading="loading" :data="operlogList" :default-sort="defaultSort"
      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作">
        <template #default="scope">
          <el-button v-hasPermi="['system:operlog:query']" icon="View" link type="primary"
    ...
    <!-- 操作日志详细 -->
    <el-dialog v-model="open" append-to-body title="操作日志详细" width="800px">
