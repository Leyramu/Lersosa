  ...
  <div class="app-container home">
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>Lersosa 多租户管理系统</h2>
        <p>
          Lersosa Plus 是基于 Lersosa 针对 分布式集群 场景升级(不兼容原框架)
          <br />
        ...
        <p>
          <el-button type="primary" icon="Cloudy" plain @click="goTarget('https://github.com/Leyramu/Lersosa')">访问码云</el-button>
          <el-button type="primary" icon="Cloudy" plain @click="goTarget('https://github.com/Leyramu/Lersosa')">访问GitHub</el-button>
          <el-button type="primary" icon="Cloudy" plain @click="goTarget('https://github.com/Leyramu/Lersosa')">更新日志</el-button>
        </p>
      </el-col>

      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>Lersosa 多租户微服务管理系统</h2>
        <p>
          Lersosa Plus 微服务通用权限管理系统 重写 Lersosa 全方位升级(不兼容原框架)
          <br />
