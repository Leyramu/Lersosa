      ...
      <el-table-column align="center" class-name="small-padding fixed-width" label="操作" width="200">
        <template #default="scope">
          <el-tooltip content="修改" placement="top">
            <el-button v-hasPermi="['monitor:job:edit']" icon="Edit" link type="primary"
                       @click="handleUpdate(scope.row)"></el-button>
          </el-tooltip>
          <el-tooltip content="删除" placement="top">
            <el-button v-hasPermi="['monitor:job:remove']" icon="Delete" link type="primary"
                       @click="handleDelete(scope.row)"></el-button>
          </el-tooltip>
          <el-tooltip content="执行一次" placement="top">
            <el-button v-hasPermi="['monitor:job:changeStatus']" icon="CaretRight" link type="primary"
                       @click="handleRun(scope.row)"></el-button>
          </el-tooltip>
          <el-tooltip content="任务详细" placement="top">
            <el-button v-hasPermi="['monitor:job:query']" icon="View" link type="primary"
                       @click="handleView(scope.row)"></el-button>
          </el-tooltip>
          <el-tooltip content="调度日志" placement="top">
            <el-button v-hasPermi="['monitor:job:query']" icon="Operation" link type="primary"
                       @click="handleJobLog(scope.row)"></el-button>
          </el-tooltip>
        </template>
      </el-table-column>
    </el-table>
              ...
              <template #label>
                        <span>
                           ...
                           <el-tooltip placement="top">
                              <template #content>
                                 <div>
                                    Bean调用示例：lersosaTask.ryParams('ry')
                                    <br/>Class类调用示例：leyramu.framework.lersosa.quartz.task.LersosaTask.lersosaParams('ry')
