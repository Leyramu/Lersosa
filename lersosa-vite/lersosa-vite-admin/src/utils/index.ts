 ...
 * @returns {string}
 */
export const formatTime = (time: string, option: string): any => {
  let t: number;
  if (('' + time).length === 10) {
 ...
 * @returns {Object}
 */
export const getQueryObject = (url: string): any => {
 ...
 * @param str
 */
export const byteLength = (str: string): any => {
 ...
 * @returns {Array}
 */
export const param = (json: any): any => {
  if (!json) return '';
  return cleanArray(
 ...
 * @returns {string}
 */
export const html2Text = (val: string): any => {
 ...
 * @returns {Object}
 */
export const objectMerge = (target: any, source: any | any[]): any => {
